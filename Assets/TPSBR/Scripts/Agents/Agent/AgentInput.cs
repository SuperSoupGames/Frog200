...
namespace TPSBR
{
	...
	public sealed class AgentInput : ContextBehaviour, IBeforeUpdate, IBeforeTick
	{
		...
		void IBeforeUpdate.BeforeUpdate()
		{
			...
			Vector2 lookRotationDelta = InputUtility.ProcessLookRotationDelta(_frameRecords, new Vector2(-mouseDelta.y, mouseDelta.x), Global.RuntimeSettings.Sensitivity, _lookResponsivity);
