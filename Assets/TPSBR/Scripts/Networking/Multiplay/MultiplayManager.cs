#define WIRE_EXCLUDE_WEBSOCKETSHARP
...
namespace TPSBR
{
	...
	public sealed class MultiplayManager : MonoBehaviour
	{
		...
		//todo HELLO THIS IS MULTIPLAY DOING A THING!! Notice the GameplayType.ToString() which is what the QUEUE NAME THAT WILL BE USED CUZ IT IS: 'battleRoyal'
